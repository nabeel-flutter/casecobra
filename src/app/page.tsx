      ...
      <section className="bg-slate-100 py-24">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h1 className="order-1 tracking-tighter !leading-tight mt-2 text-center text-balance font-bold text-5xl md:text-6xl text-gray-900">
              What are{' '}<span className=" relative px-2">customers{' '}<Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6  text-green-500" />
              </span>say{' '}
            </h1>
            <img src="snake-2.png" alt="" className="w-24 lg:order-2 order-0" />
          </div>
          <div className="mx-auto grid max-w-2xl  grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex  flex-auto  flex-col gap-4  lg:pr-8  xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feel durable and I even got a compliment on the design. Had the case for two and a half months now and <span className=" p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it."
                </p>
              </div>
              <div className="gap-4 mt-2 flex">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className=" text-green-600 stroke-[3px] w-4 h-4" />
                    <p className=" text-sm">Verified Purhase</p>
                  </div>
                </div>
              </div>
            </div>
